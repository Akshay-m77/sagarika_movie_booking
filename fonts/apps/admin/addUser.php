...
// Fetch units from the admin table
$sql = "SELECT DISTINCT unit FROM admin WHERE unit != 'admin'";
$stmt = $db->query($sql);
...
<select id="unit" name="unit" class="l" required>
    <option value="">Select Unit</option>
    <?php foreach ($units as $unit): ?>
        <option value="<?= htmlspecialchars($unit['unit']) ?>">
            <?= htmlspecialchars($unit['unit']) ?>
        </option>
    <?php endforeach; ?>
    <option value="other">Other</option> <!-- Add "Other" as a manual option -->
</select>
...
<select id="rank" name="rank" class="l" required>
    ...
    <option value="Junior sailors & equivalent">Junior sailors & equivalent</option>
                    ...
                    <input type="text" id="phone" name="phone" class="l" required>
